...
CREATE TABLE IF NOT EXISTS notification_ads (
...
CREATE OR REPLACE TRIGGER update_modified_time BEFORE UPDATE ON notification_ads FOR EACH ROW EXECUTE PROCEDURE trigger_set_timestamps();
